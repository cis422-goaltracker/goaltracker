...
select "Add Goal" if you want to create a new goal to add subgoals to 
-OR- 
select a pre-existing goal from the goal list in the main window and select "Edit/View". 
